...
import { Sparkles, FileText, ThumbsUp, ThumbsDown, Lightbulb, TrendingUp, X } from 'lucide-react';
...
export function ApplicantCard({ applicant, jobDetails }: { applicant: any, jobDetails: any }) {
