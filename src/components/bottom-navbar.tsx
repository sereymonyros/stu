    ...
    return (
        <div className={cn(
            ...
            <div className="relative pointer-events-auto flex items-center justify-center gap-2 w-full">
                         ...
                         <TooltipProvider>
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button asChild variant="ghost" size="icon" className="shadow-3xl bg-zinc-100/10 backdrop-blur-lg rounded-full border h-8 w-8" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="min-w-48 rounded-full border flex h-10 items-center justify-evenly font-medium flex-1 shadow-3xl bg-zinc-100/10 backdrop-blur-lg">
                    {navItems.map((item) => {
                     ...
                     <DropdownMenu onOpenChange={setIsMenuOpen}>
                        <DropdownMenuTrigger asChild>
                            <Button
                                variant="ghost"
                                size="icon"
                                className="rounded-full h-8 w-8 shadow-xl shadow-3xl bg-zinc-100/10 backdrop-blur-lg border"
                            >
                        ...
                        <DropdownMenuContent
                            className="w-64 mb-2 rounded-3xl shadow-3xl bg-zinc-100/10 backdrop-blur-lg"
                            side="top"
                            align="end"
                        >
                             {user && userProfile && (
                                <>
                                    ...
                                    <DropdownMenuSeparator className="bg-zinc-900/20 dark:bg-zinc-100/20" />
                                </>
                             )}
